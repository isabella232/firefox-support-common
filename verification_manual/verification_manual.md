...
1. テストケースの `popupblock.html` を開く。
    - 確認項目
        1. ポップアップブロックの通知が{{^Security-4-3}}表示される。(Security-4-1/4/5/6){{/Security-4-3}}{{#Security-4-3}}表示されずに、タブまたはウィンドウが開かれる。(Security-4-3){{/Security-4-3}}
<!--/GROUP-->
...
{{/Privacy-1-3}}
        1. 「履歴」→「記憶させる履歴を詳細設定する」が選択されており、「Firefoxの終了時に履歴を消去する」の{{#Privacy-1-2 || Privacy-1-3}}チェックが外れていて選択不可になっている。(Privacy-1-2/3){{/Privacy-1-2 || Privacy-1-3}}{{#Privacy-1-4}}チェックが入っていて選択不可になっている。(Privacy-1-4){{/Privacy-1-4}}{{#Privacy-1-5}}チェックが外れていて選択可能になっている。(Privacy-1-5){{/Privacy-1-5}}
{{#Privacy-1-4}}
