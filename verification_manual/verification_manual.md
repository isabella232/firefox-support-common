...
2. テストケースの「cross-directory.html」を開く。 
    - 確認項目 
        1. 「./cross-directory.html: 200」および「../configuration-sheets/constumize-item-list.csv: 200」の2つの出力が得られる。(Security-14-1)\
            または、「./cross-directory.html: 200 」のみが得られもう片方はエラーが出力される。(Security-14-2) 
