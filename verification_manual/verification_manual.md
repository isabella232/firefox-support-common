...
## 4.3 広告などのポップアップのブロック {.Heading_20_2}

### 4.3.1 確認する項目 {.Heading_20_3}

1. Security-4-\* 

### 4.3.2 準備： {.Heading_20_3}
...
## 5.7アイドル状態での履歴・ブックマーク用データベースの自動最適化
...
## 9.2ファイルをダウンロードして外部アプリケーションで開く際の挙動の制御
