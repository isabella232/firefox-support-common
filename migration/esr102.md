...
* SmartBlock 3.0に基づくプライバシー保護とWebページ閲覧の互換性が向上しました。[詳細](https://blog.mozilla.org/security/2021/10/05/firefox-93-features-an-improved-smartblock-and-new-referrer-tracking-protections/)（Firefox 93）
