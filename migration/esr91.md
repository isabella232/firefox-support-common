...
| 2021年11月2日 | Firefox 94             | 91.3                  |78ESRのサポート終了|

* Firefox 78ESRのサポートは、2021年11月2日で終了します（以後はセキュリティ更新が提供されません）。
...
-->
* Backspaceキーに対する「戻る」操作へのショートカット割り当てを廃止しました。（`browser.backspace_action`=`0`で再度有効化できます。）また、代替のショートカットとしてAlt-←（macOSではCommand-←）が使用できます。 (Firefox 87)
